...
/**
 * get_value - Geting the numerical value of a card.
...
/**
 * insertion_sort_deck_kind - Sorting a deck of cards from spades to diamonds.
...
/**
 * insertion_sort_deck_value - Sorting a deck of cards sorted from
