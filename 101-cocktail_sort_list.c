...
/**
 * swap_node_ahead - Swaping a node in a listint_t doubly-linked list
 *                   list of integers with the node ahead of it.
 * @list: Pointer to the head of a doubly-linked list of integers.
 * @tail: Pointer to the tail of the doubly-linked list.
 * @shaker: Pointer to the present swapping node of the cocktail shaker algo.
 */
void swap_node_ahead(listint_t **list, listint_t **tail, listint_t **shaker)
{
...
/**
 * swap_node_behind - Swaping a node in a listint_t doubly-linked
